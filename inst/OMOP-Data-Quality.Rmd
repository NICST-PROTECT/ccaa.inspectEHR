...
data_qual_df = check_date_within(st[["person"]], "year_of_birth", compare_date = Sys.Date(), 
                                 check_arg = ">=",
...
data_qual_Obs_p = find_duplicates(observation_period, 
...
data_qual_Obs_p = check_date_within(check_df=observation_period, 
...
data_qual_visit_ch = find_duplicates(st[["visit_occurrence"]], 
...
data_qual_visit_ch = check_date_within(check_df = not_nan_visit_occurrence_start_end, 
...
data_qual_visit_ch = check_date_within(check_df = st[["visit_occurrence"]], 
                                    check_date = "visit_start_date", 
...
```{r}
data_qual_visit_det = find_duplicates(visit_detail, 
...
data_qual_visit_det = check_date_within(check_df = visit_detail, 
...
data_qual_death = check_date_within(check_df = death_year, 
...
data_qual_death = check_date_within(check_df = st[["death"]], 
