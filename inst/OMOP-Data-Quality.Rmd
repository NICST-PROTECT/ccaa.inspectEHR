...
observation_period <- tbl(ctn, in_schema(schema,schema, "observation_period")) %>% as_tibble()
observation_period <- observation_period %>%
  filter(person_id %in% get_period_patients(ctn,  params$start_date, params$end_date))

visit_detail <- tbl(ctn, in_schema(schema, "visit_detail")) %>%
  as_tibble() %>%
  filter(person_id %in% get_period_patients(schema,schema, params$start_date, params$end_date))

measurements <- tbl(ctn, in_schema(schema, "measurement")) %>%
  as_tibble() %>%
  filter(person_id %in% get_period_patients(schema,schema, params$start_date, params$end_date))
...
heart_rate <- measurements %>% filter(measurement_concept_id == get_source_concept_id("heart_rate", measure_bounds))

abnormal_heart <- check_measure_bounds("heart_rate", measurements, measure_bounds)
...
temperature <- measurements %>% filter(measurement_concept_id == get_source_concept_id("temperature", measure_bounds))

abnormal_temp <- check_measure_bounds("temperature", measurements, measure_bounds)
...
respiratory_rate <- measurements %>% filter(measurement_concept_id == get_source_concept_id("respiratory_rate", measure_bounds))

abnormal_rr <- check_measure_bounds("respiratory_rate", measurements, measure_bounds)
...
diastolic_blood_pressure <- measurements %>% filter(measurement_concept_id == get_source_concept_id("diastolic_blood_pressure", measure_bounds))

abnormal_dbp <- check_measure_bounds("diastolic_blood_pressure", measurements, measure_bounds)
...
systolic_blood_pressure <- measurements %>% filter(measurement_concept_id == get_source_concept_id("systolic_blood_pressure", measure_bounds))

abnormal_sbp <- check_measure_bounds("systolic_blood_pressure", measurements, measure_bounds)
