...
## OMOP Structure at `r {params$local_hospital}`
...
plot_visit_detail_profile(visit_detail, params$start_date, params$end_date, custom_colors) %>% custom_theme(params$custom_colors)
```
