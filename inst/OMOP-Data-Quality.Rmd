...
period_person_ids <- get_period_patients(ctn, schema, params$start_date, params$end_date)
...
```{r}
clinical_tbls <- prepare_tally(ctn, schema, filter_person_ids = period_person_ids, filter_care_sites = care_sites)
...
print("Visit detail table is empty")
}
```
