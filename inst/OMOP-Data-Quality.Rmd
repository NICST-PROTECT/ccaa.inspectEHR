...
observation_period$observation_period_end_date_midnight <- observation_period$observation_period_end_date 
...
check <- "Visit detail end date time is on or before the corresponding visit occurrence end date"
